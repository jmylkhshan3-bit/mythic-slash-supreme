...
class Settings:
    ...
    def load(cls) -> 'Settings':
        ...
        return cls(
            ...
            tts_api_model=os.getenv('TTS_API_MODEL', 'model_q8f16').strip(),
            tts_api_voice=os.getenv('TTS_API_VOICE', 'af_heart').strip(),
            ...
            enable_dm_ai=os.getenv('ENABLE_DM_AI', 'true').strip().lower() in {'1', 'true', 'yes', 'on'},
        )
